...
def parse_arguments():
    ...
    parser.add_argument(
        "--model", type=str, default="gpt3", choices=["gpt-3.5-turbo-1106", "gpt3-medium", "gpt3-large", "gpt3-xl"], help="model used for decoding. Note that 'gpt3' are the smallest models."
    )
